...
-- AddForeignKey
ALTER TABLE "public"."web_access" ADD CONSTRAINT "web_access_user_email_fkey" FOREIGN KEY ("user_email") REFERENCES "public"."users"("email") ON DELETE NO ACTION ON UPDATE CASCADE;
