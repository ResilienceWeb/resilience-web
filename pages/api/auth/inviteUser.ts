    ...
    if (permission) {
      const msg = {
        ...
        html: htmlTemplate({
          ...
          mainText: `<p>You're invited to manage the groups <b>${listingTitlesConcatenated}</b> on Cambridge Resilience Web, a digital mapping of organisations in Cambridge that are working to create a more resilient, more equitable and greener future for Cambridge and its residents.</p>`,
