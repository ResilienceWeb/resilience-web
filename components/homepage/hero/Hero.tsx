        ...
        <div className="flex flex-col items-center gap-8 md:gap-12">
          <div className="items-left animate-fade-in flex flex-col gap-6 md:items-center md:gap-8">
            <h1 className="w-full text-left text-4xl leading-tight font-bold tracking-tight wrap-break-word md:w-[90%] md:text-center md:text-6xl lg:w-[80%]">
              ...
              <span className="relative z-10 inline-block w-fit text-left leading-tight font-bold wrap-break-word after:absolute after:bottom-px after:left-0 after:z-[-1] after:h-[25%] after:w-full after:bg-[#3A8159]/30 after:transition-all after:duration-300 hover:after:h-[40%] md:text-center">
                action
              </span>
            </h1>
